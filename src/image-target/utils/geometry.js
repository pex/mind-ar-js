...
export { matrixInverse33 };
export { matrixMul33 };
export { quadrilateralConvex };
export { smallestTriangleArea };
export { multiplyPointHomographyInhomogenous };
export { checkThreePointsConsistent };
export { checkFourPointsConsistent };
export { determinant };
export default {
  matrixInverse33,
  matrixMul33,
